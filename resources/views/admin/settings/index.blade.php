        ...
        <div class="col-lg-8">
            ...
            <div class="form-card">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="company_name_ar" class="form-control" value="{{ $settings['company_name_ar'] ?? '' }}">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="company_years" class="form-control" value="{{ $settings['company_years'] ?? '15' }}">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">عدد العملاء</label>
                        <input type="number" name="total_clients" class="form-control" value="{{ $settings['total_clients'] ?? '1200' }}">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">عدد الدول</label>
                        <input type="number" name="countries_count" class="form-control" value="{{ $settings['countries_count'] ?? '8' }}">
                    </div>
                </div>
            </div>
            ...
            <div class="form-card">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="phone_default" class="form-control" value="{{ $settings['phone_default'] ?? '' }}">
                    </div>
                    <div class="col-md-4">
            ...
            <div class="form-card border-warning">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="phone_iraq" class="form-control" value="{{ $settings['phone_iraq'] ?? '' }}">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">واتساب (العراق)</label>
                        <input type="text" name="whatsapp_iraq" class="form-control" value="{{ $settings['whatsapp_iraq'] ?? '' }}" placeholder="+9647501234567">
                    </div>
                    <div class="col-md-4">
            ...
            <div class="form-card">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="about_text_ar" class="form-control" rows="4">{{ $settings['about_text_ar'] ?? '' }}</textarea>
                </div>
                <div class="mb-3">
        ...
        <div class="col-lg-4">
            ...
            <div class="form-card">
                ...
                <div class="mb-3">
                    ...
                    <input type="url" name="facebook_url" class="form-control form-control-sm" value="{{ $settings['facebook_url'] ?? '' }}">
                </div>
                <div class="mb-3">
                    <label class="form-label"><i class="fab fa-instagram text-danger me-1"></i>Instagram</label>
                    <input type="url" name="instagram_url" class="form-control form-control-sm" value="{{ $settings['instagram_url'] ?? '' }}">
                </div>
                <div class="mb-3">
                    <label class="form-label"><i class="fab fa-twitter text-info me-1"></i>Twitter / X</label>
                    <input type="url" name="twitter_url" class="form-control form-control-sm" value="{{ $settings['twitter_url'] ?? '' }}">
                </div>
                <div class="mb-3">
                    <label class="form-label"><i class="fab fa-youtube text-danger me-1"></i>YouTube</label>
                    <input type="url" name="youtube_url" class="form-control form-control-sm" value="{{ $settings['youtube_url'] ?? '' }}">
                </div>
                <div class="mb-3">
                    <label class="form-label"><i class="fab fa-linkedin text-primary me-1"></i>LinkedIn</label>
                    <input type="url" name="linkedin_url" class="form-control form-control-sm" value="{{ $settings['linkedin_url'] ?? '' }}">
                </div>
                <div class="mb-3">
                    <label class="form-label"><i class="fab fa-tiktok me-1"></i>TikTok</label>
                    <input type="url" name="tiktok_url" class="form-control form-control-sm" value="{{ $settings['tiktok_url'] ?? '' }}">
                </div>
            </div>
            ...
            <div class="form-card">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="meta_title_ar" class="form-control form-control-sm" value="{{ $settings['meta_title_ar'] ?? '' }}">
                </div>
                <div class="mb-3">
