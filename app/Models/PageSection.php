...
class PageSection extends Model
{
    ...
    public static function seedDefaults(): void
    {
        $defaults = [
            ...
            ['page' => 'home', 'key' => 'why_us',    'label' => 'لماذا نحن',        'sort_order' => 3],
            ['page' => 'home', 'key' => 'about',     'label' => 'من نحن',           'sort_order' => 4],
            ['page' => 'home', 'key' => 'latest',    'label' => 'أحدث المشاريع',    'sort_order' => 5],
            ['page' => 'home', 'key' => 'cta',       'label' => 'دعوة للتواصل',     'sort_order' => 6],
        ];
